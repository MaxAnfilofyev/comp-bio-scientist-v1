...
AGGREGATOR_SYSTEM_MSG = f"""You are an ambitious computational biology researcher who is preparing final plots for a scientific paper submission.
...
def aggregate_plots(
    base_folder: str, model: str = "gpt-5-mini-2025-08-07", n_reflections: int = 5
) -> None:
...
def main():
    ...
    parser.add_argument(
        ...
        help="LLM model to use (default: gpt-5-mini-2025-08-07).",
    )
    parser.add_argument(
        "--reflections",
        type=int,
