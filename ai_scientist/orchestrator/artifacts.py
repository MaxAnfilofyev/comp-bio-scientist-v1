...
ARTIFACT_TYPE_REGISTRY: Dict[str, Dict[str, str]] = {
    ...
    "model_spec": {
        "rel_dir": "models",
        "pattern": "{model_key}_spec_{version}.json",
        "description": "JSON specification of the model and simulation parameters.",
    },
    ...
    "transport_manifest": {
        "rel_dir": "simulations/transport_runs",
        "pattern": "manifest.json",
        "description": "Transport run manifest index.",
    },
    "transport_sim_json": {
        "rel_dir": "simulations/transport_runs/{baseline}/transport_{transport}/seed_{seed}",
    ...
    "sensitivity_sweep_table": {
        "rel_dir": "simulations/sensitivity_sweep",
    ...
    "intervention_table": {
        "rel_dir": "simulations/interventions",
